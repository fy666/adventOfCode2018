...
pub fn get_pos(mov: char, pos: &(i32, i32)) -> (i32, i32) {
    match mov {
        ...
        _ => println!("! {} not a valid move", mov),
    };
    *pos
}
...
pub fn run(file: &String) {
    ...
    println!("Imported {} moves", text.len());
    ...
    *all_positions_puzzle2.entry(position).or_insert(0) += 1;
    ...
    println!(
        "PUZZLE 1 {} visited houses 🏡 ",
        all_positions_puzzle1.len()
    );
    println!(
        "PUZZLE 2 {} visited houses 🏡 ",
